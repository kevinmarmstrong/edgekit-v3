...
Use that only on machines with Chrome AI/Nano, WebGPU/WebLLM readiness, and any required app-owned cloud route configured. Keep secrets out of the browser and point optional env vars at safe test routes or proxies.
